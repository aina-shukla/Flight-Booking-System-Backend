package com.airlinesService.models;
...
public class Airlines {
	...
	public Airlines(int flightNumber, String flighId, String airlineName) {
		super();
	...
	public Airlines(int flightNumber, String flighId, String airlineName, String fromPlace, String toPlace,
